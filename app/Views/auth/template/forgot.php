                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="line-height: 24px; padding: 0 0 30px 0;">
                                            <center>
                                                <p style="margin: 10px 0;">Klik link dibawah ini untuk update Password</p>
                                            </center>
                                            <br>
                                            <center>
                                                <a style="text-decoration:none; background: lightcoral; padding: 10px 20px; border-radius: 5px; color:#fff;" href="<?= _DOMAIN . '/' . date('dmy') * date('dmy') . '/' . $pin ?>">UPDATE PASSWORD</a>
                                            </center>
